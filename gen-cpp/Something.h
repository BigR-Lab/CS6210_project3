...
typedef struct _Something_request_args__isset {
  _Something_request_args__isset() : req(false) {}
  bool req :1;
} _Something_request_args__isset;

class Something_request_args {
 public:

  Something_request_args(const Something_request_args&);
  Something_request_args& operator=(const Something_request_args&);
  Something_request_args() {
  }

  virtual ~Something_request_args() throw();
  Url_req req;

  _Something_request_args__isset __isset;

  void __set_req(const Url_req& val);

  bool operator == (const Something_request_args & rhs) const
  {
    if (!(req == rhs.req))
      return false;
    return true;
  ...
  bool operator < (const Something_request_args & ) const;
...
class Something_request_pargs {
 public:


  virtual ~Something_request_pargs() throw();
  const Url_req* req;
...
typedef struct _Something_request_result__isset {
  _Something_request_result__isset() : success(false) {}
  bool success :1;
} _Something_request_result__isset;

class Something_request_result {
 public:

  Something_request_result(const Something_request_result&);
  Something_request_result& operator=(const Something_request_result&);
  Something_request_result() : success() {
  }

  virtual ~Something_request_result() throw();
  std::string success;

  _Something_request_result__isset __isset;

  void __set_success(const std::string& val);

  bool operator == (const Something_request_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Something_request_result & ) const;
...
typedef struct _Something_request_presult__isset {
  _Something_request_presult__isset() : success(false) {}
  bool success :1;
} _Something_request_presult__isset;

class Something_request_presult {
 public:


  virtual ~Something_request_presult() throw();
  std::string* success;

  _Something_request_presult__isset __isset;
...
class SomethingProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  SomethingProcessor(boost::shared_ptr<SomethingIf> iface) :
    ...
    processMap_["request"] = &SomethingProcessor::process_request;
  }
