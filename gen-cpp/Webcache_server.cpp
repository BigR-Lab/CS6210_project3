...
class WebcacheHandler : virtual public WebcacheIf {
 public:
  WebcacheHandler() {
...
int main(int argc, char **argv) {
  ...
  shared_ptr<WebcacheHandler> handler(new WebcacheHandler());
  shared_ptr<TProcessor> processor(new WebcacheProcessor(handler));
